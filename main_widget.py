...
class Main_widget(MDScreen):
    ...
    _updateWidget = None
    _tags={}
    def __init__(self,scan_time,server_ip,server_port,modbus_addrs,**kwargs):
        super().__init__(**kwargs)
    ...
    def read_data(self):
        ...
        try:
            ...
            #Snackbar(text="Updating error, see terminal",bg_color=(1,0,0,1)).open()
            print("O erro foi", e)
            self._mbusclient.close()
